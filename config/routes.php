...
return [
    ...
    ['GET', '/diag/test-xml-debug',    'DiagController@testXmlDebug',     []],
...
//     ['POST', '/register',             'AuthController@register',                  []],
    ...
    ['GET', '/api/v1/scraped-reviews/stats', 'ApiController@scrapedStats',   []],
    ...
    ['POST',   '/scraped-reviews/sync-done',             'ScrapedReviewController@syncDone',      ['auth','approved','module:scraped_reviews']],
    ...
    ['POST',   '/photo/rotate',               'PhotoController@rotate',        ['auth']],
